...
class AgentResponse(BaseModel):
    ...
    answer: str = Field(description="The main answer or response to the user's query")

    # Sources used (optional)
    sources: Optional[List[str]] = Field(
        default=None, description="List of sources or references used to generate the answer"
    )
    ...
    key_points: Optional[List[str]] = Field(
        default=None, description="List of key points or takeaways from the response"
    )
